...
/*   Updated: 2024/03/02 21:14:57 by zech-chi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node	*ft_build_tree(void)
{
	...
	root = NULL;
	root = ft_insert_node(root, ft_strdup("||"), 8, OR);
	root = ft_insert_node(root, ft_strdup("&&"), 4, AND);
	root = ft_insert_node(root, ft_strdup("||"), 11, OR);
	root = ft_insert_node(root, ft_strdup("&&"), 2, AND);
	root = ft_insert_node(root, ft_strdup("||"), 6, OR);
	root = ft_insert_node(root, ft_strdup("echoa"), 1, CMD);
	root = ft_insert_node(root, ft_strdup("echo b"), 3, CMD);
	root = ft_insert_node(root, ft_strdup("ls -la"), 5, CMD);
	root = ft_insert_node(root, ft_strdup("echo d"), 7, CMD);
	root = ft_insert_node(root, ft_strdup("gffg"), 9, CMD);
	root = ft_insert_node(root, ft_strdup("echo f"), 12, CMD);
	return (root);
}
